...
def placer_valeur(joueur,premier_joueur,symbole,plateau,ligne,colonne,choix,tour,dejavu) :
	
	coordonnees = traduction(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
	ligne = coordonnees[0]
...
def estPossible(plateau,joueur,premier_joueur,symbole,ligne,colonne,choix,tour,dejavu) :
	...
	if joueur == "IA" :
		if plateau[ligne][colonne] == "O" or plateau[ligne][colonne] == "X" :
			return False
		obligation(tour,dejavu,plateau,symbole,joueur,premier_joueur)
...
def traduction(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu) :
...
def verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu) :
	...
	ligne = coordonnees[0]
	colonne = coordonnees[1]
	while estPossible(plateau,joueur,premier_joueur,symbole,ligne,colonne,choix,tour,dejavu) == False :
		verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)		
	placer_valeur(joueur,premier_joueur,symbole,plateau,ligne,colonne,choix,tour,dejavu)
	return choix
...
def obligation(tour,dejavu,plateau,symbole,joueur,premier_joueur) :
...
def decision(plateau,joueur,premier_joueur,symbole,tour,dejavu) :
	...
	colonne = coordonnees[1]
	while erreur == 1 :
		if estPossible(plateau,joueur,premier_joueur,symbole,ligne,colonne,choix,tour,dejavu) == False :
			choix = randint(1,9)
			coordonnees = traduction(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
			ligne = coordonnees[0]
			colonne = coordonnees[1]
...
def morpion() :
	...
	if premier_joueur == "joueur" :
		choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
		if choix == 2 :
			placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,8,tour,dejavu)
			choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
			if choix == 4 :
				placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,6,tour,dejavu)
				choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
				if choix == 1 :
					placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,5,tour,dejavu)	
				else :
					placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,1,tour,dejavu)
			else :
				placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,4,tour,dejavu)
				choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
				if choix == 6 :
					placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,1,tour,dejavu)
					if estPossible(plateau,joueur,premier_joueur,symbole,ligne,colonne,choix,tour,dejavu) == False :
						placer_valeur(joueur,premier_joueur,symbole,plateau,ligne,colonne,5,tour,dejavu)
				else :
					placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,3,tour,dejavu)
					if estPossible(plateau,joueur,premier_joueur,symbole,ligne,colonne,choix,tour,dejavu) == False :
						placer_valeur(joueur,premier_joueur,symbole,plateau,ligne,colonne,5,tour,dejavu)
		else : 
			placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,2,tour,dejavu)
			choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
			if choix == 4 :
				placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,6,tour,dejavu)
				if estPossible(plateau,joueur,premier_joueur,symbole,ligne,colonne,choix,tour,dejavu) == False :
					placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,7,tour,dejavu)
					choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
					if choix == 1 :
						placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,3,tour,dejavu)
					else :
	...
	if premier_joueur == "IA" :
		...
		for i in range (2) :
			choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
			choix_copie = choix_miroir(choix)
			placer_valeur("IA",premier_joueur,symbole,plateau,ligne,colonne,choix_copie,tour,dejavu)
		choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
	tour = 6
	while estVictorieux(joueur,premier_joueur,symbole,plateau) != True :
		if premier_joueur == "IA" :
			plateau = decision(plateau,joueur,premier_joueur,symbole,tour,dejavu)
			tour += 1
		choix = verification_demande(choix,plateau,joueur,premier_joueur,symbole,tour,dejavu)
		tour += 1
		if premier_joueur == "joueur" :
