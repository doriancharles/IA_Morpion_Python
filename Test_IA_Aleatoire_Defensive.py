...
def coupBloquant(plateau,premier_joueur,symbole,joueur) :
...
def decision(plateau,joueur,premier_joueur,symbole) :
	...
	erreur = 1
	choix = coupBloquant(plateau,premier_joueur,symbole,joueur)
	if choix not in (1,10) :
		choix = randint(1,9)
		coordonnees = traduction_choix(choix)
		ligne = coordonnees[0]
		colonne = coordonnees[1]
...
def morpion() :
	...
	# Mettez des # avant les 3 apostroples des lignes 369 et 371
	# Enlevez les # des lignes 375 et 377
	#'''
	symbole = "O"
	#'''
	...
	# Mettez des # avant les 3 apostroples des lignes 375 et 377
	# Enlevez les # des lignes 369 et 371
	'''
	symbole = "X"
	'''	
	# Si vous voulez essayer la partie où le joueur commence et si les instructions suivantes n'ont pas déjà été effectuées :
	# Mettez des # avant les 3 apostroples des lignes 381 et 457
	# Enlevez les # des lignes 461 et 540
	#'''	
	...
	# Mettez des # avant les 3 apostroples des lignes 461 et 540
	# Enlevez les # des lignes 381 et 457
	'''
	premier_joueur = "IA"
	joueur = "IA"
