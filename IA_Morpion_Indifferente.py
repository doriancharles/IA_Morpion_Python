...
def estPossible(plateau,joueur,symbole,ligne,colonne) :
...
def verification(plateau,joueur,symbole,ligne,colonne,choix) :
	
	while estPossible(plateau,joueur,symbole,ligne,colonne) == False :
...
def traduction(choix,plateau,joueur,premier_joueur,symbole) :
	...
	verification(plateau,joueur,symbole,ligne,colonne,choix)
...
def decision(plateau,joueur,premier_joueur,symbole,reponse) :
	...
	if choix == 3 or choix == 6 or choix == 9 :
		colonne = 2
	while erreur == 1 :
		if estPossible(plateau,joueur,symbole,ligne,colonne) == False :
			choix = randint(1,9)
			if choix == 1 or choix == 2 or choix == 3 :
				ligne = 0
			if choix == 4 or choix == 5 or choix == 6 :
