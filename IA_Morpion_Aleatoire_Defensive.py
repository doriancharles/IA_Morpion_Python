...
def decision(plateau,joueur,premier_joueur,symbole,reponse) :
	...
	erreur = 1
	joueur = "IA"
	ignorer = coupBloquant(plateau,premier_joueur,symbole,joueur,reponse)
	if ignorer == False :
		choix = randint(1,9)
		coordonnees = traduction(choix)
		ligne = coordonnees[0]
...
def coupBloquant(plateau,premier_joueur,symbole,joueur,reponse) :
...
def morpion() :
	...
	reponse = "a"
	symbole = "a"
	print("IA morpion aleatoire défensive")
	print("")
