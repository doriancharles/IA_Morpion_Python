...
def coupGagnant(plateau,premier_joueur,symbole,joueur,reponse) :
...
def decision(plateau,joueur,premier_joueur,symbole,reponse) :
	...
	erreur = 1
	joueur = "IA"
	coupGagnant(plateau,premier_joueur,symbole,joueur,reponse)
	choix = randint(1,9)
	coordonnees = traduction(choix)
	ligne = coordonnees[0]
	colonne = coordonnees[1]
...
def morpion() :
	...
	reponse = "a"
	symbole = "a"
	print("IA morpion aleatoire attaquante")
	print("")
